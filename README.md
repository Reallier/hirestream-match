...
- 📄 **智能OCR**：支持PDF简历及图片格式（JPG/PNG/GIF/BMP/WEBP）的精准文字识别
- 🖼️ **多格式支持**：除PDF外，还支持直接上传简历截图或扫描件
...
2. **上传简历**：选择候选人的简历文件（≤2MB）
   - 支持格式：PDF、JPG、PNG、GIF、BMP、WEBP
   - 可直接上传简历截图或扫描件
...
### v1.1（当前版本）
- [x] ✅ 支持图片格式简历（JPG/PNG/GIF/BMP/WEBP）
- [ ] 内置岗位模板（技术/销售/设计）
- [ ] 支持 DOCX 和 TXT 简历格式
- [ ] 添加历史记录功能
